...
{% set custom_content %}
	{% if not reduced_item %}
		...
		{% set has_custom_percentage_off_promotion_label = promotional_offer.isPercentageOff and promotional_offer.custom_label and promotional_offer.custom_label | trim %}
...
{{ component(
	'product-item', {
		...
		product_item_classes: {
			...
			quick_shop_modal_trigger: 'js-modal-open-private js-quickshop-modal-open btn btn-primary btn-small' ~ slide_item_quick_shop_modal_trigger_class,
    ...
    image: '
        {% set ahorro = 100 | times: product.list_price | minus: product.price | divided_by: product.list_price | round %}
<div class="descuento-badge{% if product.price < product.list_price %} con-descuento{% endif %}">
