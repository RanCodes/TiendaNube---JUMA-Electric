...
{% if use_slider %}
        {% set section_slider_classes =
                ...
                section_slider_mobile_only ? 'swiper-mobile-only flex-nowrap flex-md-wrap grid ' ~ grid_mobile_class ~ ' ' ~ grid_desktop_class :
